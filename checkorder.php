                     ...
                     <div class="col-lg-8">
                        <div class="p-5">
                           <div class="d-flex justify-content-between align-items-center mb-5">
                              <h1 class="fw-bold mb-0 text-black">ตรวจสอบคำสั่งซื้อ</h1>
                           </div>
                           <hr class="my-4">
                           ...
                           <div class="pt-5">
                              <h6 class="mb-0"><a href="cart.php" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>กลับสู่ตะกร้า</a></h6>
                           </div>
                        </div>
                        ...
                        echo '<div class="col-lg-4 bg-grey">
                            ...
                            <a href="payment.php"><button type="button" class="btn btn-dark btn-block btn-lg" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                                data-mdb-ripple-color="dark" id="purchase">ชำระเงิน</button></a>
                            </div>
                        </div>';
                        ?>
                  </div>
